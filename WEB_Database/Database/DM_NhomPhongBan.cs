...
namespace WEB_Database.Database
{
    ...
    public partial class DM_NhomPhongBan
    {
        public System.Guid id { get; set; }
        public string ma_nhomphongban { get; set; }
        public string ten_nhomphongban { get; set; }
        public Nullable<int> stt { get; set; }
        public string ma_nhomphongban_nhom { get; set; }
