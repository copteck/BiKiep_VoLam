...
namespace WEB_Database.Database
{
    ...
    public partial class DM_CaLamViec
    {
        public System.Guid id { get; set; }
        public string ma_calamviec { get; set; }
        public string ten_calamviec { get; set; }
        public Nullable<System.DateTime> tugio { get; set; }
        public Nullable<System.DateTime> dengio { get; set; }
        public Nullable<decimal> sogio_nghi { get; set; }
        public string is_comtrua { get; set; }
        public Nullable<int> soluong_comtrua { get; set; }
        public string is_comtoi { get; set; }
        public Nullable<int> soluong_comtoi { get; set; }
