...
namespace WEB_Database.Database
{
    ...
    public partial class ht_dm_nsd_nhom_phanquyen
    {
        public System.Guid id { get; set; }
        public string ma_nsd { get; set; }
        public Nullable<int> is_taomoi_thanhvien { get; set; }
        public Nullable<int> is_duyet_dangky_nhanvien_nhacungcap { get; set; }
