...
namespace WEB_Database.Database
{
    ...
    public partial class ns_nhanvien_tinhtranglamviec
    {
        public System.Guid id { get; set; }
        public string ma_nv { get; set; }
        public string tinhtrang_lamviec { get; set; }
        public string is_tinhluong { get; set; }
        public string is_tinhbaohiem { get; set; }
        public Nullable<System.DateTime> ngayapdung { get; set; }
        public string is_hethan { get; set; }
