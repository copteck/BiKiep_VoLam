...
namespace WEB_Database.Database
{
    ...
    public partial class DM_MucDichMuaBan
    {
        public System.Guid id { get; set; }
        public string ma_mucdich { get; set; }
        public string ten_mucdich { get; set; }
        public string filter_taikhoan { get; set; }
        public Nullable<int> stt { get; set; }
        public string ghichu { get; set; }
        public Nullable<int> khongsudung { get; set; }
        public string is_muahang { get; set; }
