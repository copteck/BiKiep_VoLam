...
namespace WEB_Database.Database
{
    ...
    public partial class DM_DonViTinh_BaoCao
    {
        public System.Guid id { get; set; }
        public string ma_hh { get; set; }
        public string ma_dvt { get; set; }
        public string dvt_cap1 { get; set; }
        public string dvt_cap2 { get; set; }
        public string dvt_cap3 { get; set; }
        public string dvt_cap4 { get; set; }
        public string dvt_cap5 { get; set; }
