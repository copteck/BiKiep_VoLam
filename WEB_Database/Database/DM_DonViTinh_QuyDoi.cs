...
namespace WEB_Database.Database
{
    ...
    public partial class DM_DonViTinh_QuyDoi
    {
        public System.Guid id { get; set; }
        public string ma_hh { get; set; }
        public string ma_dvt { get; set; }
        public Nullable<decimal> heso { get; set; }
        public string ma_dvt_quydoi { get; set; }
        public Nullable<decimal> heso_quydoi { get; set; }
        public Nullable<int> dvt_chuan { get; set; }
        public Nullable<int> capbaocao { get; set; }
