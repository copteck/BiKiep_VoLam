...
namespace WEB_Database.Database
{
    ...
    public partial class DM_NhanCong
    {
        public System.Guid id { get; set; }
        public string ma_nhancong { get; set; }
        public string ten_nhancong { get; set; }
        public string dv_tinh { get; set; }
        public string loainhancong { get; set; }
        public Nullable<int> bactho { get; set; }
