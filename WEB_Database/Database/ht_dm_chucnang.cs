...
namespace WEB_Database.Database
{
    ...
    public partial class ht_dm_chucnang
    {
        ...
        public string is_loadpage { get; set; }
        ...
        public string is_baohanh { get; set; }
        public string is_xaydung { get; set; }
        public string is_nhansu { get; set; }
        public string is_nhahang { get; set; }
        public string is_vanchuyen { get; set; }
